! Parallel sum of a 1D array, evenly or unevenly distributed between all ranks.
!
! Compile and run:
!
...
!+  TODO: replace with 4 different solutions using collectives.
    !---------------------------------------------------------------------------
...
!+  TODO: replace with a reduction to the root.
